...
const TemplateMiLanding = () => {
  const landingPageData = {
    ...
    backgroundImage: portada2,
    title: 'AYURBANA ',
    bookButtonText: 'Book Now',
    bookDescription: 'Schedule a consultation with us today.',
    consultationButtonText: 'Get Consultation',
    ctaWhatsappButton: '¡más informacion!',
    iframeBackground: '',
    subtitles: ['Encuentra tu equilibrio interior', 'Clases para todos los niveles', 'Bienestar integral y armonía'],
    telefono: '+56954558744',
    instagramLink: '',
    facebookLink: '',
    gpsLink: 'https://maps.app.goo.gl/ZKNYbvTkSy3gAjQ87',
    footerAfterStyles: {
